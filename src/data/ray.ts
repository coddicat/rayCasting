...
export type BlockHandler =  (params:{ bx: number, by: number, distance: number }) => RayAction;
...
class Ray {
    ...
    constructor(vector: Vector, blockHandler: BlockHandler, mirrorHandle?: MirrorHandler) {

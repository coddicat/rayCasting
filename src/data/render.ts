...
class Render {
    ...
    public static handleObject(data: Uint32Array, params: { displayX: number, distance: number, mirrorFact: number, color: number, top: number, bottom: number }, playerState: PlayerState, pixelCounter: { count: number }): boolean {

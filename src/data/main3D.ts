...
import { getDukeFrontSpriteData, getFloor1SpriteData, getWallBriksSpriteData } from "./spriteLoader";
...
export class Main3D {
  ...
  public renderMain() {
    ...
    this.context.scale(
      this.context.canvas.width / consts.lookWidth,
      this.context.canvas.height / consts.lookHeight
    );
